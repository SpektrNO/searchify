...
| ID | Feature | Status | Spec |
|----|---------|--------|------|
| `phase2-local-keyword` | index_paths + search_local (BM25) | ⬜ | [architecture.md](./architecture.md) |

## C. Hybrid local search

| ID | Feature | Status | Spec |
|----|---------|--------|------|
| `phase3-hybrid-local` | In-process vectors, RRF, optional LangSearch rerank | ⬜ | [architecture.md](./architecture.md) |
