...
| `opt-richer-file-types` | Extract and index PDF, Office, images (OCR), HTML/CSV and related formats beyond the text/code allowlist — [#24](https://github.com/SpektrNO/searchify/issues/24) | ⬜ | [architecture.md](./architecture.md) |
