...
| Open tasks | `engine` (#26), `verify` (#27), `docs` (#28) |
| Closed this phase | `spec` (#25) |
...
- Stretch P1 formats deferred (pptx/odf/rtf/eml) if not shipped
- P2 formats
- Optional `POST /v1/…` discovery of supported extensions
- Stronger OCR (in-process) without external Tesseract
