...
REM set "SEARCHIFY_EMBED_ENGINE=kjarni"
REM set "SEARCHIFY_EMBED_MODEL=minilm-l6-v2"
REM set "SEARCHIFY_EMBED_MODEL=mpnet-base-v2"
REM Ollama (embedding model; server must be running for embed + vector search):
REM set "SEARCHIFY_EMBED_ENGINE=ollama"
REM set "SEARCHIFY_EMBED_MODEL=nomic-embed-text"
REM set "SEARCHIFY_EMBED_URL=http://127.0.0.1:11434"
...
if defined SEARCHIFY_EMBED_ENGINE (echo SEARCHIFY_EMBED_ENGINE=%SEARCHIFY_EMBED_ENGINE%) else (echo SEARCHIFY_EMBED_ENGINE: default kjarni)
...
if defined SEARCHIFY_EMBED_URL (echo SEARCHIFY_EMBED_URL=%SEARCHIFY_EMBED_URL%)
